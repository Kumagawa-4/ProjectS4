        ...
        <div class="container">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Modifier une activite sportive</h3>
              </div>
              <div class="card-body">
                <form action="<?php echo site_url().'index.php/AdminController/modifActivity'?>" method="post">
                  <div class="form-group">
                    <label for="name">Nom de l'activite</label>
                    <input type="text" class="form-control" name="nom" id="name" placeholder="<?php echo $activity['nom'] ?>" value="<?php echo $activity['nom'] ?>">
                  </div>
