          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <thead>
                    <tr>
                    <th class="sorting">Type de regime</th>
                    <th class="sorting">Duree</th>
                    <th class="sorting">Poids</th>
                    <th></th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach($regime as $r){?>
                        <tr>
                            ...
                            <td class="dtr-control"><?php echo $r['poids']; ?></td>
                            <td><a type="button" class="btn btn-block bg-gradient-info">Modifier</a></td>
                            <td><a type="button" class="btn btn-block bg-gradient-danger">Supprimer</a></td>
                            <td><a type="button" class="btn btn-block bg-gradient-secondary">Details</a></td>
                        </tr>
                    <?php } ?>
