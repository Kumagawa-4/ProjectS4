    ...
    <body>
        <div class="container">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="<?php echo site_url().'index.php/AdminController/addMenu'?>" method="post">
                  <div class="form-group">
                    <label for="name">Plat</label>
                    <select class="select2" data-placeholder="Choisir un plat" style="width: 100%;" name="idPlat">
