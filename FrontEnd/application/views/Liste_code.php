                            ...
                            <tbody>
                                ...
                                <?php for($i = 0; $i<count($codes); $i++){  ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url('index.php/Code_controller/valider/' . $codes[$i]['id_code']) ?>"><button type="button" class="btn btn-block  bg-gradient-info">Valider</button></a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
